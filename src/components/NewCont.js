...
const NewCont = () => {
  return (
    ...
    <img src={kente_home} className='explanation_img hover_img' alt=''/>
      ...
      <p>We make well defining dresses based on the need of consumers. Customer satisfaction is our piority , giving you what you need when you need it and where you need it .</p>
